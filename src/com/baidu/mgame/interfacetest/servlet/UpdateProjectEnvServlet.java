 ...
 * @version V1.0
 */
public class UpdateProjectEnvServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        UpdateProjectEnvResponse resp = null;
        Integer pid = null;
        ...
        try {
            ...
            resp = this.projectService.getProjectUrlByPid(pid);
        ...
        // 返回页面
        request.getRequestDispatcher("WebRoot/projectUrl.jsp").forward(request, response);
    }
